...
export const register = async (req, res, next) => {
  try {
    ...
    // Create role-specific profile docs
    // NOTE: Vendor profile is NOT created here — vendor fills business details
    //       on their dashboard after first login (businessName is required there)
